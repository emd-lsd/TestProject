package main.java.ru.raiffeisen.cc.testproject.version.wordcountnonblockingmultithread.filestat.wordstatistics;

import main.java.ru.raiffeisen.cc.testproject.version.wordcountnonblockingmultithread.filestat.service.WordCounterService;
import main.java.ru.raiffeisen.cc.testproject.version.wordcountnonblockingmultithread.filestat.service.WordFrequencyService;
...
public class WordCounterTask implements Runnable {
    ...
    public WordCounterTask(Path filePath, Queue<Integer> countsQueue, Queue<FileWordStats> fileWordStats, Queue<Map<String, Integer>> globalWordStats) {
